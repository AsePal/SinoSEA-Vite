...
export default function TopNav({ user, onNewChat, onLogout, onEditAvatar }: TopNavProps) {
  return (
    <header
    ...
    >
      ...
      <div className="flex items-center gap-3 min-w-0 md:min-w-[220px] justify-end">
        <button type="button" className="btn-primary hidden sm:inline-flex" onClick={onNewChat}>
          新对话
        </button>
