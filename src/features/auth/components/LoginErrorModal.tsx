  ...
  return createPortal(
    <AnimatePresence>
      {open && (
        ...
        >
          <motion.div
            className="w-[92%] max-w-md rounded-2xl bg-white px-8 py-7 shadow-xl border border-gray-200 text-gray-900 dark:bg-zinc-800 dark:border-white/10 dark:text-white"
