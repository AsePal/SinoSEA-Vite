...
import { ArrowLeftIcon, ClockIcon, CheckCircleIcon, CpuChipIcon } from "@heroicons/react/24/outline";
...
const Section = ({ title, children }: { title: string; children: React.ReactNode }) => (
  <section className="mb-8">
    <h2 className="mb-3 text-lg font-semibold text-indigo-700 border-b pb-2">
      {title}
    </h2>
